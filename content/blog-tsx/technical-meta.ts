...
export const technicalMeta = [
  ...
  resilienceFortressMeta,
  observabilityIntelligenceMeta,
  humanAgentCoManagementMeta,
  recursiveSafetyMeta,
  ...
  aiCodeDebtTsunamiMeta,
  metricsThatMatterMeta,
  semanticDuplicateDetectionMeta,
  hiddenCostImportChainsMeta,
  mcpSuperpowersContextAwareMeta,
  mcpSuperpowersCustomToolsMeta,
  mcpSuperpowersOrchestrationLoopMeta,
  theTokenTaxMeta,
  the9MetricsMeta,
  livingDocumentationMeta,
  architectingForAgentsMeta,
  readinessScorecardMeta,
